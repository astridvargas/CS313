...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Cousine|Oswald&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        <div class="container">
            <img id="mainPicture" src="us.jpg" alt="Us">
            <div class="content">
        ...
        <h1>Student // Developer // Sushi Lover // Wife</h1>
        ...
        <div class="gridContainer">
            <div>
                ...
                <a href="../web/Week02/assignment02.1.html">
                    <img class="smallPictures" src="more.jpg" alt="About">
                </a>
            </div>
